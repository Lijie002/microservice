package com.qixinmini.gateway.handler;
 ...
 * gateway异常信息转换
 * @author lijie
 * @createTime 2020-11-20 14:24:08
 */
@Slf4j
public class MicroserviceGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public MicroserviceGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties, ErrorProperties errorProperties, ApplicationContext applicationContext) {
